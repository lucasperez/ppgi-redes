...
class PackageThreadReport
  ...
  def generate_report
    ...
    report_text = report_text + "<table class='table table-bordered'><tr><th>1 Thread</th><th>3 Thread</th><th>5 Thread</th></tr><tr><td>#{test_1_thread} Mb/s</td><td>#{test_3_thread} Mb/s</td><td>#{test_5_thread} Mb/s</td></tr></table>"

    report_text = report_text + "<div class='well'>Percebemos que quanto mais aumentamos o número de threads maior a velocidade de conexão<br><br></div></p>"
