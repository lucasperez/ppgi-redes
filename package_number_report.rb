...
class PackageNumberReport
  ...
  def generate_report
    ...
    report_text = report_text + "<table class='table table-bordered'><tr><th>Recebendo 1 pacote</th><th>Recebendo 3 pacotes</th><th>Recebendo 5 pacotes</th></tr><tr><td>#{test_1_package} Mb/s</td><td>#{test_3_packages} Mb/s</td><td>#{test_5_packages} Mb/s</td></tr></table>"
