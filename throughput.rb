...
report_text = report_text + "<p>A ideia do trabalho é estimar a velocidade de conexão em função de alguns parâmetros. Vamos alterar alguns parametros da conexão e analisar como que isso afeta a estimativa de velocidade.</p>"
